...
namespace Lession06_DbConText.Models;
...
//        => optionsBuilder.UseSqlServer("Data source=.\\SQLEXPRESS;Initial Catalog=BookStore;User ID=sa; password=saaaaaaaa; MultipleActiveResultSets=True; TrustServerCertificate=True ");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Account>(entity =>
        {
            entity.HasKey(e => e.AccountId).HasName("PK__Account__349DA5A6C698FB73");
        ...
        {
            entity.HasKey(e => e.BookId).HasName("PK__Book__3DE0C2075239494F");
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__Category__19093A0BCDC20157");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__OrderBoo__C3905BCF632F4C7C");
        ...
        {
            entity.HasKey(e => e.OrderDetailId).HasName("PK__OrderDet__D3B9D36C10117806");
        ...
        {
            entity.HasKey(e => e.PublisherId).HasName("PK__Publishe__4C657FABAB8ECBC7");
