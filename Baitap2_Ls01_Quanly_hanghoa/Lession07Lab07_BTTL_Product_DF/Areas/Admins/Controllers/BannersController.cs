...
namespace Lession07Lab07_BTTL_Product_DF.Areas.Admins.Controllers
{
    ...
    public class BannersController : Controller
    {
        ...
        public BannersController(ProductContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Banners != null ? 
                          ...
                          Problem("Entity set 'ProductContext.Banners'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ProductContext.Banners'  is null.");
            }
            var banner = await _context.Banners.FindAsync(id);
            if (banner != null)
            {
